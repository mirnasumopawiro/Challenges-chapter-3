...
int main() {
    ...
    float propertyTax;
    float currentRate;
    float seniorPropertyTax;
    float quarterlyTax;
    float seniorAssessmentValue;
    
    cout << "Please input the value of your property: $";
    cin >> propertyValue;
    cout << "Please input the current tax rate: $";
    cin >> currentRate;
    ...
    cout << "The senior property tax is $" << seniorPropertyTax << endl;
